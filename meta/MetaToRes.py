...
class MetaToRes:
    ...
    def ubah_nama(self,input_text):
        ...
        Contoh:
        - "jenis_barang" -> "JenisBarangResource"
        """
        if not input_text:
            return ""
    ...
    def cek_out_type(self, i, refs_data, max_length=10):
        ...
        if(i['type'] == 'timestamp'):
            ...
            ri = f'$this->{i["name"]} ?  \Carbon\Carbon::parse($this->{i["name"]})->format("h:i") : ""'
        #---------------------------------------------------------
...
'''
        with open("out/app/Http/Resources/BaseResource.php", "w") as file:
                    file.write(tex) 
