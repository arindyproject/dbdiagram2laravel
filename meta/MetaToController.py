...
class MetaToController:
    ...
    def json_to_model(self, table_data, refs_data):
        ...
        mod+= f'use App\Http\Controllers\Controller; \n'
        mod+= f'use Illuminate\Http\Request; \n'
        mod+= f'use Illuminate\Support\Facades\Auth; \n'
        mod+= f'use Illuminate\Support\Facades\Validator; \n\n'
        mod+= f'use App\Http\Resources\BaseResource; \n'
        mod+= f' \n'

        mod+= 'Class ' + model_name+ ' extends Controller { \n'
        #construct
        #-------------------------------------------------
        mod+= '    //construct----------------------------------------------\n'
